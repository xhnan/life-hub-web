 ...
 */
export const getAccountTreeApi = () => {
  return http.get<AccountRow[]>(`${prefix}/subjects/tree`);
};
 ...
 */
export const getAccountChildrenApi = (parentId?: number) => {
  return http.get<AccountRow[]>(`${prefix}/subjects`, { params: { parentId } });
};
...
export const getAccountListApi = () => {
  return http.get<AccountRow[]>(`${prefix}`);
};
...
export const getAccountDetailApi = (id: number) => {
  return http.get<AccountRow>(`${prefix}/${id}`);
};
